...
def build_csv(excel_path, word_path, save_path):  
    ...
    for index,row in dfall.iterrows():   #遍历dataframe的每一行
        ...
        if document:
            ...
            accuser = re.match(r'.*?原告人?[^\u4e00-\u9fa5]*(.*?)([^\u4e00-\u9fa5]|与|等|被告)', a)  # 找出原告被告
    ...
    df_test.to_csv(os.path.join(save_path, "df.csv"), index=False, encoding='utf_8_sig')
...
if __name__ == '__main__':
    ...
    # build_csv("/root/corpus/excel汇总", '/root/corpus/word汇总', "/root/corpus")
    built_ner_data("D:/corpus/df_test.csv","D:/corpus/无讼/word汇总","D:/test.txt")
    built_ner_data("D:/corpus/df_train.csv", "D:/corpus/无讼/word汇总", "D:/train.txt")